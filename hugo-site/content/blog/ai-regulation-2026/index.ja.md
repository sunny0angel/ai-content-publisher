...
本レポートは、EU AI Act（規則2024/1689）、AI Law Tracker、Presenc AIのポリシートラッカー、White & Caseのグローバル規制トラッカー、DLA PiperのAI Laws of the World、中国のCAC執行記録、韓国AI基本法、日本のAI促進法、州レベルの立法追跡データを統合し、2026年半ばのAI規制の一元的な参照源を提供する。AI規制と国家安全保障の交わりについては、[米国政府のAI管理努力の分析](/blog/us-government-vs-anthropic-ai-control-2026/)をご参照ください。
...
EU AI Officeは運用中で、汎用AIモデルの監督を実施している。全27加盟国の国内市場監視当局がハイリスク義務を執行する。米国企業の場合、執行はEU法定代理人、EUビジネスパートナー、またはインシデントや苦情に基づく直接調査を通じて行われる。実務上の影響：EU居住者を評価するAI採用ツールを運用する米国SaaS企業は、欧州に物理的拠点がなくても附属書IIIの雇用規定を遵守しなければならない。これらの規制対象システムの多くは[プロダクション環境で展開されるAIエージェント](/blog/ai-agents-report-2026/)であり、複数のフレームワークの下で同時に義務を負う。
...
*出典：Presenc AI、AI Law Tracker、Cooley、King & Spalding、2026年7月時点。コロラド州SB 24-205は2026年4月27日に連邦治安判事により停止。代替案としてSB 189が2026年5月に可決。*

より大きな全体像：2026年3月時点で、45州が1,561件のAI関連法案を提出している（multistate.ai調べ）。連邦対州の優位争いは、米国政策の支配的なストーリーである。DOJが優位性の訴訟に勝利すれば、州AI法は大幅に弱まる——コンプライアンスはFTC、EEOC、CFPB、HHSによって執行される分野別連邦ルールに簡素化される。州が勝利すれば、規制環境はベンダーが2023年から覚悟してきたパッチワーク状態となり、事業を展開するすべての州で異なる要件が生じる可能性がある。
...
中国のラベリング要件は世界で最も詳細である。レイヤー1は可視ラベルを要求——テキスト、音声キュー、またはユーザーが即座に認識できるグラフィックオーバーレイ。レイヤー2はメタデータの埋め込みを要求——プロバイダー名、固有コンテンツID、圧縮・トリミング・再配布後も持続する暗号化データを含む隠し透かし。プラットフォームは受信コンテンツを検出し、3段階（確認済み、可能性あり、疑わしいAI生成）に分類しなければならない。

罰則は運用的である：アカウント停止、コンテンツ削除、重大な違反には刑事告発。2026年2月の執行措置では、CACが一度の波で13,421アカウントを処罰した。中国ユーザーにリーチするコンテンツを提供する外国AIサービスプロバイダーは、本拠地に関わらずこれらの規則の対象となる。国際開発者にとっての実務的意味：中国本土のユーザーがアクセス可能なテキスト、画像、音声、動画を生成するAI製品は、二重ラベリングを実装し、ユーザー要求により配信された未ラベルコンテンツの6ヶ月間の保持ログを含むコンプライアンス文書を維持しなければならない。
...
| ベトナム | AI法 | 2026年3月1日 | 東南アジア初の包括的AI法、リスクベースのラベリング |
| サウジアラビア | PDPL + SDAIA原則 | 運用中 | AIを統治するデータ保護フレームワーク |
| UAE | 戦略主導 | 運用中 | 専用AI法なし、拘束力のあるデータ保護法 |

*出典：DLA Piper、White & Case、AI Law Tracker、2026年7月。英国、日本、シンガポールの原則ベースのアプローチは、EUや中国よりも直接的なコンプライアンス義務は少ないが、それでも文書化されたガバナンスプロセスを必要とする。カナダのAIDAは停滞したままで、2026年の成立の見込みは立っていない。*
