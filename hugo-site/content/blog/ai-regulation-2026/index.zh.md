...
本报告整合了EU AI Act（第2024/1689号法规）、AI Law Tracker、Presenc AI的政策追踪器、White & Case的全球监管追踪器、DLA Piper的AI世界法律、中国网信办执法记录、韩国AI基本法、日本AI促进法以及州级立法追踪数据，为2026年中的AI监管提供单一参考来源。关于AI监管如何与国家安全交织，请参阅我们对[美国政府AI控制努力的分析](/blog/us-government-vs-anthropic-ai-control-2026/)。
...
![水平柱状图：各司法管辖区最高AI罚款对比（USD换算）](/images/charts/ai-regulation-2026-chart-1.png "各司法管辖区最高AI罚款（$M USD换算）：欧盟Tier 1（禁止行为）$3,800万、韩国$2,200万、加拿大提案$1,800万、欧盟Tier 2（义务）$1,600万、巴西提案$900万、欧盟Tier 3（虚假信息）$800万。中国因使用运营性制裁（账户暂停、内容删除）而非固定罚款被排除。来源：EU AI Act第99条、韩国AI基本法、DLA Piper。")

EU AI Office已开始运作，对通用AI模型进行监督。所有27个成员国的国家市场监督机构将执行高风险义务。对于美国公司，执行通过其欧盟授权代表、欧盟业务伙伴或由事件或投诉触发的直接调查进行。实际影响：一家使用AI招聘工具评估欧盟居民的美国SaaS公司，即使在欧洲没有实体存在，也必须遵守附件III的雇佣条款。这些受监管的系统中有许多是[部署在生产环境中的AI代理](/blog/ai-agents-report-2026/)，同时承担多个框架下的义务。
...
*来源：Presenc AI、AI Law Tracker、Cooley、King & Spalding，截至2026年7月。科罗拉多州SB 24-205于2026年4月27日被联邦治安法官暂停。科罗拉多州替代法案SB 189于2026年5月通过。*

更大的图景：截至2026年3月，45个州已提出1,561项AI相关法案（数据来源：multistate.ai）。联邦与州的优先权之争是美国政策的核心议题。如果DOJ赢得优先权挑战，州AI法律将大幅削弱——合规将简化为由FTC、EEOC、CFPB和HHS执行的部门联邦规则。如果各州获胜，监管环境将变成供应商自2023年以来一直在准备的拼凑局面，可能在每个运营州都有不同的要求。
...
中国的标签要求是全球最详细的。第一层要求可见标签——文本、音频提示或用户能立即识别的图形叠加。第二层要求嵌入元数据——包含提供商名称、唯一内容标识符和经压缩、裁剪和重新分发后仍能存续的加密数据的隐藏水印。平台必须检测传入内容并将其分为三个等级（确认、可能或疑似AI生成）。

处罚是运营性的：账户暂停、内容删除，严重违规移交刑事处理。2026年2月的执法行动显示CAC愿意大规模行动——单次行动处罚了13,421个账户。内容覆盖中国用户的境外AI服务提供商无论总部位于何处均受这些规则约束。对国际开发者的实际影响：任何生成中国境内用户可访问的文本、图片、音频或视频的AI产品都必须实施双重标签，并维护合规文档，包括应请求交付的未标记内容的六个月保留日志。
...
| 越南 | AI法 | 2026年3月1日 | 东南亚首部全面AI法，基于风险的标签制度 |
| 沙特阿拉伯 | PDPL + SDAIA原则 | 已运作 | 治理AI的数据保护框架 |
| 阿联酋 | 战略主导 | 已运作 | 无专门AI法，有约束力的数据保护法 |

*来源：DLA Piper、White & Case、AI Law Tracker，截至2026年7月。英国、日本和新加坡采用基于原则的方法，直接合规义务少于欧盟或中国，但仍然要求有记录在案的治理流程。加拿大AIDA仍处于停滞状态，2026年无明确的通过路径。*
