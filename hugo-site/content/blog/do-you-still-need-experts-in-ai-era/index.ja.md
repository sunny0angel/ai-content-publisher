...
初期導入企業は業界を問わず同様のパターンをたどっている。Shopifyはエンジニアリング組織をAI強化型の「プロダクトエンジニア」中心に再設計し、フロントエンド、バックエンド、インフラの専門家に分割するのではなく、機能をエンドツーエンドで所有させている。KlarnaのAIアシスタントは700人分のフルタイムカスタマーサポート業務を処理し、残った人間チームは複雑なエスカレーションと品質保証に集中している——これは教科書通りのTier 1展開だ。コンテンツマーケティングでは、かつて各プロジェクトに別々のライター、エディター、グラフィックデザイナーを割り当てていた代理店が、現在はAI強化型のジェネラリストを配置し、初稿の作成、ビジュアルの生成、セルフ編集を単一のワークフロー内で行っている。

このパターンはテクノロジー業界をはるかに超えて広がっている。AIツールを使用する会計事務所は、パートナーあたりのクライアント数が30〜40%増加している。AIによる文書レビューを使用する法律事務所は、ディスカバリーチームを5人のアソシイトから1人のパートナーとAIに削減した。いずれの場合も、ジェネラリストと深い専門家の比率が変化している：より少ない人数がより良いツールでより多くの作業を行い、真の専門知識のプレミアムは、それが希少になるからこそ上昇している。この変革が世界の雇用構造にどのような影響を与えているかについては、[AI時代のグローバル人事の未来](/ja/blog/future-global-hr-ai/)の分析をご参照ください。
